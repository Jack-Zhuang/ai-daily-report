...
<body>
    ...
    <script>
        ...
        function showPickDetail(index) {{
            ...
            // 添加链接按钮
            detailHtml += `<a href="${{itemLink}}" target="_blank" class="detail-link"><i class="fas fa-external-link-alt"></i> ${{pickType === 'github' ? '访问 GitHub' : (pickType === 'paper' ? '阅读论文' : '阅读原文')}}</a>`;
                    ...
                    <div class="card" onclick="showPaperDetail(${{i}})">
                        ...
                        <div class="card-body">
                            ...
                            <div class="card-footer">
                                ...
                                <span class="card-link">阅读论文 <i class="fas fa-external-link-alt"></i></span>
                            </div>
                        </div>
                    </div>
                `;
